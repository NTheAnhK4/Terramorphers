...
namespace JSAM.JSAMEditor
{
    public class AudioLibraryEditor : JSAMSerializedEditorWindow<AudioLibrary, AudioLibraryEditor>
    {
        ...
        SerializedProperty musicAssembly;
        ...
        SerializedProperty soundAssembly;
        ...
        protected override void DesignateSerializedProperties()
        {
            ...
            soundNamespaceGenerated = FindProp(nameof(asset.soundNamespaceGenerated));
            musicAssembly = FindProp(nameof(asset.musicAssembly));
            soundAssembly = FindProp(nameof(asset.soundAssembly));
            ...
            else
            {
                ...
                if (showCustomNames)
                {
                    using (new EditorGUI.DisabledScope(!useCustomNames.boolValue))
                    {
                        ...
                        blontent = new GUIContent("Sound Assembly", "Adds a custom Assembly to generated sound enums.");
                        RenderCodeField(soundAssembly, blontent, true, "Change Sound Assembly", "Assembly-CSharp");
                        ...
                        blontent = new GUIContent("Music Assembly", "Adds a custom Assembly to generated sound enums.");
                        RenderCodeField(musicAssembly, blontent, true, "Change Music Assembly", "Assembly-CSharp");
                    }
                }
                EditorCompatability.EndSpecialFoldoutGroup();
